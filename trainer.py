...
def trainer_lc(args, model, snapshot_path):
    ...
    db_train = Tumor(data_path=args.root_path, mode='Training',
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            image_batch, label_batch = sampled_batch['image_b'], sampled_batch['label_b']
            image_batch, label_batch = image_batch.cuda(), label_batch.cuda()
            image_batch, label_batch,image_batch1 = sampled_batch['image_b'], sampled_batch['label_b'],sampled_batch['image_n']
            image_batch, label_batch,image_batch1 = image_batch.cuda(), label_batch.cuda(),image_batch1.cuda()
...
def trainer_lc_fusion(args, model, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs,fd_loss, da_loss,_,_,_,_ = model(image_b_batch, image_n_batch)
